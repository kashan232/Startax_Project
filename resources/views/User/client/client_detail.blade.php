                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="House-Property">
                          <label class="form-check-label" for="House-Property">
                            House Property
                          </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="Capital-Gain">
                          <label class="form-check-label" for="Capital-Gain">
                            Capital Gain
                          </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="Other-incom">
                          <label class="form-check-label" for="Other-incom">
                            Other Income
                          </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="VDA-Income">
                          <label class="form-check-label" for="VDA-Income">
                            VDA Income
                          </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="" id="Exempt-Income">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control rounded-0 text-uppercase" placeholder="Enter Your AADHAAR NO" />
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control rounded-0" placeholder="Enter Your No" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control rounded-0 text-uppercase" placeholder="Enter Your IFSC Code" />
                                    </div>
                                    <!-- Bank Name -->
                                    <div class="form-group">
                                      <label class="m-0">Bank Name</label>
                                      <input type="text" class="form-control rounded-0" placeholder="Enter Your Bank Name" />
                                    </div>
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control rounded-0" min="1" max="99999999999999999999" placeholder="Enter Your Bank Account No" />
                                    </div>
                                    <!-- Account Type -->
                                    <div class="form-group">
                        ...
                        <div class="mt-3 inerr-tab-cntnt">
                          ...
                          <form action="#">
                            <div class="card card-body">
                              <div class="form_heading">
                                <h5 class="mt-3">
                                  <strong>Assets from Crypto wallets
                                  </strong>
                                </h5>
                                <span>*As per the tax laws from ITD, all the
                                  positive gains from VDA assets will be
                                  taxable
                                </span>
                              </div>
                                    ...
                                    <tr>
                                      <td>
                                        <div class="form-group">
                                          <label class="m-0">
                                            Asset name</label>
                                          <input type="text" class="form-control rounded-0" placeholder="Enter Your Asset name" />
                                        </div>
                                      </td>
                                      <td>
                                        <div class="form-group">
                                          <label class="m-0">Buy date</label>
                                          <input type="date" class="form-control rounded-0" />
                                        </div>
                                      </td>
                                      <td>
                                        <div class="form-group">
                                          <label class="m-0">Sell date</label>
                                          <input type="date" class="form-control rounded-0" />
                                        </div>
                                      </td>
                                      <td>
                                        <div class="form-group">
                                          <label class="m-0">Buy value</label>
                                          <input type="text" class="form-control rounded-0" placeholder="Enter your Value" />
                                        </div>
                                      </td>
                                      <td>
                                        <div class="form-group">
                                          <label class="m-0">Sell value</label>
                                          <input type="text" class="form-control rounded-0" placeholder="Enter your Sell value" />
                                        </div>
                                      </td>

                                      <td>
                                        <div class="form-group">
                                          <label class="m-0">Income head</label>
                                          <select class="form-control rounded-0">
                                            <option>Select Option</option>
                                            <option value="IRG">
                                              Capital Gains
                                      ...
                                      <td>
                                        <div class="form-group">
                                          <label class="m-0">Gains* </label>
                                          <input type="text" class="form-control rounded-0" placeholder="Enter your Gains*
                                                " />
                                        </div>
                                      </td>
                                      <td>
